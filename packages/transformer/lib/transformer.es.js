...
var TransformerHandle = /** @class */ (function (_super) {
    ...
    function TransformerHandle(handle, styleOpts, handler, commit, cursor) {
        ...
        _this._pointerPosition = new Point();
...
var tempParentMatrix = new Matrix();
/**
...
var tempCorners = [new Point(), new Point(), new Point(), new Point()];
var tempMatrix$2 = new Matrix();
var tempPoint = new Point();
var tempBounds = new OrientedBounds();
...
var Transformer = /** @class */ (function (_super) {
    ...
    function Transformer(options) {
         ...
         */
        _this.projectionTransform = new Matrix();
        /**
         ...
         */
        _this.wireframe = _this.addChild(new Graphics());
        /**
        ...
        _this.groupBounds = new OrientedBounds();
     ...
     */
    Transformer.calculateOrientedBounds = function (displayObject, bounds) {
        var parent = !displayObject.parent ? displayObject.enableTempParent() : displayObject.parent;
        displayObject.updateTransform();
        displayObject.disableTempParent(parent);
     ...
     * @param skipUpdate
     */
    Transformer.calculateGroupOrientedBounds = function (group, rotation, bounds, skipUpdate) {
        if (skipUpdate === void 0) { skipUpdate = false; }
