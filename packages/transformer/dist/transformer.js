...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@pixi/interaction'), require('@pixi/display'), require('@pixi/math'), require('@pixi/graphics'), require('@pixi-essentials/bounds'), require('@pixi-essentials/object-pool')) :
    typeof define === 'function' && define.amd ? define(['exports', '@pixi/interaction', '@pixi/display', '@pixi/math', '@pixi/graphics', '@pixi-essentials/bounds', '@pixi-essentials/object-pool'], factory) :
    (global = global || self, factory(global._pixi_essentials_transformer = {}, null, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI));
}(this, (function (exports, interaction, display, math, graphics, bounds, objectPool) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var emitMatrix = new math.Matrix(); // Used to pass to event handlers
...
Object.assign(this.PIXI, _pixi_essentials_transformer);
