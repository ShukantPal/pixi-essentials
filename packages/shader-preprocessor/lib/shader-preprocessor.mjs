...
var ProgramTemplate = /** @class */ (function () {
    ...
    ProgramTemplate.prototype.generateProgram = function (data, name) {
        ...
        var program = new Program(vertexSrc, fragmentSrc, name || this.name || 'pixi-processed-shader');
...
export { ProgramTemplate, ShaderPreprocessor };
//# sourceMappingURL=shader-preprocessor.mjs.map
