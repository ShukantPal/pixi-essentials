...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('pixi-batch-renderer'), require('@pixi/constants'), require('@pixi/core'), require('@pixi/math'), require('@pixi/display'), require('gl-mat3')) :
    typeof define === 'function' && define.amd ? define(['exports', 'pixi-batch-renderer', '@pixi/constants', '@pixi/core', '@pixi/math', '@pixi/display', 'gl-mat3'], factory) :
    (global = global || self, factory(global._pixi_essentials_conic = {}, global.PIXI.brend, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.mat3));
}(this, (function (exports, pixiBatchRenderer, constants, core, math, display, mat3) { 'use strict';

    mat3 = mat3 && Object.prototype.hasOwnProperty.call(mat3, 'default') ? mat3['default'] : mat3;
...
Object.assign(this.PIXI, _pixi_essentials_conic);
