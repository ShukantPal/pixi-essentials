 ...
 * Compiled Mon, 24 Aug 2020 18:29:05 UTC
 *
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@pixi/core'), require('@pixi/constants'), require('@pixi/utils')) :
    typeof define === 'function' && define.amd ? define(['exports', '@pixi/core', '@pixi/constants', '@pixi/utils'], factory) :
    (global = global || self, factory(global._pixi_essentials_instanced_renderer = {}, global.PIXI, global.PIXI, global.PIXI));
}(this, (function (exports, core, constants, utils) { 'use strict';
     ...
     */
    class InstancedRenderer extends core.ObjectRenderer {
        /**
        ...
        constructor(renderer, options) {
             ...
             * @member {PIXI.State}
             */
            this._state = options.state || core.State.for2d();
            /**
         ...
         */
        _getBuffer(size) {
            const roundedP2 = utils.nextPow2(Math.ceil(size));
            ...
            if (!buffer) {
                this._aBuffers[roundedSize] = buffer = new core.ViewableBuffer(roundedSize);
            }
            return buffer;
        }
        /**
        ...
        _calculateInstanceSizesAndViews() {
            ...
            for (const attribID in this._geometry.attributes) {
                ...
                switch (attribute.type) {
                    case constants.TYPES.UNSIGNED_BYTE:
                        typeSize = 1;
                        view = 'uint8View';
                        break;
                    case constants.TYPES.UNSIGNED_SHORT:
                    case constants.TYPES.UNSIGNED_SHORT_5_6_5:
                    case constants.TYPES.UNSIGNED_SHORT_4_4_4_4:
                    case constants.TYPES.UNSIGNED_SHORT_5_5_5_1:
                    case constants.TYPES.HALF_FLOAT:
                        typeSize = 2;
        ...
        _initInstanceBuffer() {
            ...
            const clonedGeometry = new core.Geometry();
            for (const attribID in this._geometry.attributes) {
                const attribute = this._geometry.attributes[attribID];
...
Object.assign(this.PIXI, _pixi_essentials_instanced_renderer);
